...
class GalleryAdapter(
    val onClick: (GalleryModel) -> Unit,
) : ListAdapter<GalleryModel, GalleryViewHolder>(AdapterCallbacks.galleryCallback) {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): GalleryViewHolder = GalleryViewHolder.from(parent)
