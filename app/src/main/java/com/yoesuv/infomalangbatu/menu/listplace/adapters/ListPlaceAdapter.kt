...
class ListPlaceAdapter(
    val onItemClick: (PlaceModel) -> Unit,
) : ListAdapter<PlaceModel, ListPlaceViewHolder>(AdapterCallbacks.listPlaceCallback) {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): ListPlaceViewHolder = ListPlaceViewHolder.from(parent)

    override fun onBindViewHolder(
        holder: ListPlaceViewHolder,
        position: Int,
    ) {
