...
class ChildFragmentLibrariesViewModel : ViewModel() {
    ...
    fun setupData(context: Context) {
        ...
        listLibraries.add(
            LibraryModel(
                context.getString(R.string.aosp),
                context.getString(R.string.aosp_url),
                context.getString(R.string.aosp_license),
                false,
            ),
        )
        listLibraries.add(
        ...
        listLibraries.add(
            LibraryModel(
                ...
                context.getString(R.string.glide_url),
                context.getString(R.string.glide_license),
                false,
            ),
        )
        listLibraries.add(
            LibraryModel(
                ...
                context.getString(R.string.icons8_url),
                context.getString(R.string.icons8_license),
                false,
            ),
        )
        listLibraries.add(
            LibraryModel(
                context.getString(R.string.okhttp),
                context.getString(R.string.okhttp_url),
                context.getString(R.string.okhttp_license),
                false,
            ),
        )
        listLibraries.add(
            LibraryModel(
                ...
                context.getString(R.string.retrofit_url),
                context.getString(R.string.retrofit_license),
                false,
            ),
        )
        listLibraries.add(
